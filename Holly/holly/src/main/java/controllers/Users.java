...
public class Users{
    ...
    @POST
    @Path("add")
    public String UsersAdd(@FormDataParam("Email") String Email, @FormDataParam("NameUser") String NameUser, @FormDataParam("Password") String Password) {
        System.out.println("Invoked Users.UsersAdd()");
        try {
            PreparedStatement ps = Main.db.prepareStatement("INSERT INTO Users (Email, NameUser, Admin, Password) VALUES (?, ?, ?, ?)");
